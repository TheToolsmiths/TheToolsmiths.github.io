---
layout: codex_page
title: Tools Related Sessions for Infrastructure & Reliability
permalink: /codex/gdc/infrastructure_n_reliability/sessions
codex_page_type: lvl2
nav_tag: gdc
---
{% include JB/setup %}

<!-- To Edit or Add content to this page please edit the _data/gdc_sessions.yaml file (look for track_name : infrastructure_n_reliability) -->
{% assign track_names = site.data.gdc_sessions | sort: 'track_name' %}

{% for track in track_names %}

	{% if track.track_name == "infrastructure_n_reliability" %}
